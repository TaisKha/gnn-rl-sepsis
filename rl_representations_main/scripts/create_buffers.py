  ...
  def create_buffers_and_save(self):
        ...
        for i_set, loader in enumerate(all_loaders_list):
            ...
            for dem, ob, ac, l, t, scores, rewards, idx in loader:       
                ...
                #cur_obs.shape=torch.Size([128, 19])
                
            
                # print(mask.shape) #mask.shape=torch.Size([128, 19])
                ...
                # print("Current observation after masking")
                # print(f"{cur_obs.shape=}") #cur_obs.shape=torch.Size([~1600, 33])
                # print("Current actions after masking")
                # print(cur_actions.shape) #cur_actions.shape=torch.Size([~1600, 25])
                # print("Current rewards after masking")
                # print(cur_rewards.shape) #cur_rewards.shape=torch.Size([~1600])
...
if __name__ == '__main__':
    ...
    # np.random.seed(common_params['random_seed'])
